...
exports.VnpayResponseStatus = exports.VnPayRefundStatus = exports.VnPayQueryDrStatus = void 0;
var VnpayResponseStatus = exports.VnpayResponseStatus = [{
  code: '00',
...
var VnPayQueryDrStatus = exports.VnPayQueryDrStatus = [{
  code: "02",
  ...
  code: "94",
  message: "Yêu cầu bị trùng lặp trong thời gian giới hạn của API (Giới hạn trong 5 phút)"
}, {
  code: "97",
...
var VnPayRefundStatus = exports.VnPayRefundStatus = [{
  code: "02",
  message: "Tổng số tiền hoản trả lớn hơn số tiền gốc"
}, {
  code: "03",
  message: "Dữ liệu gửi sang không đúng định dạng"
}, {
  ...
  code: "91",
  message: "Không tìm thấy giao dịch yêu cầu hoàn trả"
}, {
  code: "93",
  message: "Số tiền hoàn trả không hợp lệ. Số tiền hoàn trả phải nhỏ hơn hoặc bằng số tiền thanh toán."
}, {
  code: "94",
  message: "Yêu cầu bị trùng lặp trong thời gian giới hạn của API (Giới hạn trong 5 phút)"
}, {
